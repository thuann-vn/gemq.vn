...
function u(t4) {
    ...
    return u = function (t5) {
        ...
        return e2.prototype = Object.create(t5.prototype, {
            constructor: {
                value: e2,
                enumerable: false,
                writable: true,
...
var f = String.prototype.replace, a = /%20/g, c = "RFC3986", l = {
    default: c, formatters: {
        RFC1738: function (t4) {
            return f.call(t4, a, "+");
        }, RFC3986: function (t4) {
            return String(t4);
        }
    }, RFC1738: "RFC1738", RFC3986: c
    ...
    arrayToObject: y, assign: function (t4, r2) {
        ...
        for (var r2 = [{obj: {o: t4}, prop: "o"}], e2 = [], n2 = 0; n2 < r2.length; ++n2)
            for (var o2 = r2[n2], i2 = o2.obj[o2.prop], u2 = Object.keys(i2), f2 = 0; f2 < u2.length; ++f2) {
                ...
                "object" == typeof c2 && null !== c2 && -1 === e2.indexOf(c2) && (r2.push({
                    obj: i2,
                    prop: a2
                }), e2.push(c2));
            }
...
}, S = function t3(r2, e2, n2, o2, i2, u2, f2, a2, c2, l2, s2, v2, p2, y2) {
    var b2, h2 = r2;
    ...
    return x2;
}, k = Object.prototype.hasOwnProperty, x = Array.isArray, T = {
    allowDots: false,
    ...
    if (t4) {
        var o2 = e2.allowDots ? t4.replace(/\.([^.[]+)/g, "[$1]") : t4, i2 = /(\[[^[\]]*])/g,
            u2 = e2.depth > 0 && /(\[[^[\]]*])/.exec(o2), f2 = u2 ? o2.slice(0, u2.index) : o2, a2 = [];
        if (f2) {
    ...
    var e2 = function (t5) {
        ...
        return {
            allowDots: void 0 === t5.allowDots ? T.allowDots : !!t5.allowDots,
            allowPrototypes: "boolean" == typeof t5.allowPrototypes ? t5.allowPrototypes : T.allowPrototypes,
            arrayLimit: "number" == typeof t5.arrayLimit ? t5.arrayLimit : T.arrayLimit,
            charset: void 0 === t5.charset ? T.charset : t5.charset,
            charsetSentinel: "boolean" == typeof t5.charsetSentinel ? t5.charsetSentinel : T.charsetSentinel,
            comma: "boolean" == typeof t5.comma ? t5.comma : T.comma,
            decoder: "function" == typeof t5.decoder ? t5.decoder : T.decoder,
            delimiter: "string" == typeof t5.delimiter || d.isRegExp(t5.delimiter) ? t5.delimiter : T.delimiter,
            depth: "number" == typeof t5.depth || false === t5.depth ? +t5.depth : T.depth,
            ignoreQueryPrefix: true === t5.ignoreQueryPrefix,
            interpretNumericEntities: "boolean" == typeof t5.interpretNumericEntities ? t5.interpretNumericEntities : T.interpretNumericEntities,
            parameterLimit: "number" == typeof t5.parameterLimit ? t5.parameterLimit : T.parameterLimit,
            parseArrays: false !== t5.parseArrays,
            plainObjects: "boolean" == typeof t5.plainObjects ? t5.plainObjects : T.plainObjects,
            strictNullHandling: "boolean" == typeof t5.strictNullHandling ? t5.strictNullHandling : T.strictNullHandling
        };
    }(r2);
    if ("" === t4 || null == t4)
    ...
    return e2.matchesUrl = function (t5) {
        ...
        var e3 = this.template.replace(/(\/?){([^}?]*)(\??)}/g, function (t6, e4, n3, o3) {
                var i3,
                    u3 = "(?<" + n3 + ">" + ((null == (i3 = r2.wheres[n3]) ? void 0 : i3.replace(/(^\^)|(\$$)/g, "")) || "[^/?]+") + ")";
                return o3 ? "(" + e4 + u3 + ")?" : "" + e4 + u3;
            }).replace(/^\w+:\/\//, ""), n2 = t5.replace(/^\w+:\/\//, "").split("?"), o2 = n2[0], i2 = n2[1],
            u2 = new RegExp("^" + e3 + "/?$").exec(decodeURI(o2));
        if (u2) {
    ...
    return f2.toString = function () {
        ...
        return this.i.compile(this.u) + function (t6, r3) {
            var e2, n3 = t6, o2 = function (t7) {
                ...
                return ("function" == typeof t7.filter || g(t7.filter)) && (o3 = t7.filter), {
        ...
        var t5, r2, e2, n3, o2, i3, u3 = "undefined" != typeof window ? window.location : {}, f3 = u3.host,
            a2 = u3.pathname, c2 = u3.search;
        return {
            host: null != (t5 = null == (r2 = this.t.location) ? void 0 : r2.host) ? t5 : void 0 === f3 ? "" : f3,
            pathname: null != (e2 = null == (n3 = this.t.location) ? void 0 : n3.pathname) ? e2 : void 0 === a2 ? "" : a2,
...
createServer(
    (page) => createInertiaApp({
        ...
        resolve: (name) => resolvePageComponent(`./Pages/${name}.tsx`, /* @__PURE__ */ Object.assign({
            "./Pages/Account/Dashboard.tsx": () => import("./assets/Dashboard-w_X6Eyyl.js"),
            "./Pages/Account/OrderDetail.tsx": () => import("./assets/OrderDetail-TrDCu8AV.js"),
            "./Pages/Account/Orders.tsx": () => import("./assets/Orders-yR8zn_am.js"),
            "./Pages/Account/Profile/Edit.tsx": () => import("./assets/Edit-E1dim8hV.js"),
            "./Pages/Account/Profile/Partials/DeleteUserForm.tsx": () => import("./assets/DeleteUserForm-xYX3UAmg.js"),
            "./Pages/Account/Profile/Partials/UpdatePasswordForm.tsx": () => import("./assets/UpdatePasswordForm-bIjy5fOB.js"),
            "./Pages/Account/Profile/Partials/UpdateProfileInformationForm.tsx": () => import("./assets/UpdateProfileInformationForm-IT8LFuuX.js"),
            "./Pages/Account/Wishlist.tsx": () => import("./assets/Wishlist-YvPZA56N.js"),
            "./Pages/Auth/ConfirmPassword.tsx": () => import("./assets/ConfirmPassword-McWYEYv_.js"),
            "./Pages/Auth/ForgotPassword.tsx": () => import("./assets/ForgotPassword-YCnNHBo1.js"),
            "./Pages/Auth/Login.tsx": () => import("./assets/Login-IJfi7en6.js"),
